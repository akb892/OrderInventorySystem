...
public class InventoryController {
	...
	public ResponseEntity<List<Map<String,Object>>> fetchInventoryDetails(@PathVariable int storeId){
	 ...
	 @GetMapping("/{orderId}")
	    public ResponseEntity<List<Map<String, Object>>> fetchOrderDetails(@PathVariable int orderId) {
	 ...
	 @GetMapping("/shipments")
	    public ResponseEntity<List<Map<String, Object>>> fetchProductsCountByShipmentStatus() {
	  ...
	  @GetMapping("/category/{color}")
	    public ResponseEntity<List<Inventory>> getInventoriesByCategory(@PathVariable String color) {
